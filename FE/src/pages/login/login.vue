...
<template>
  <div class="container-fluid p-0 bg-login">
    <div class="row g-0 justify-content-end">
      <div class="col-xl-5 col-md-6 col-12 px-md-2 login-box">
...
.card-login{
  ...
  border-radius: 10px;
  box-shadow: 0 19px 50px #1f021e, 0 15px 15px #2c032a;
}
...
.login-submit {
  color: #fff !important;
  background: linear-gradient(135deg, #061348, #0e96dc) !important;
  border: none;
}
